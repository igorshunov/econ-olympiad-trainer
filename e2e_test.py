...
def main():
    with sync_playwright() as p:
        ...
        assert "index" in page.url, f"expected index, got {page.url}"
        page.screenshot(path="/home/igor/study/diploma/docs/screenshots/e2e_01_login.png", full_page=True)
        ...
        page.screenshot(path="/home/igor/study/diploma/docs/screenshots/e2e_02_dashboard.png", full_page=True)
        print("  url:", page.url)
        ...
        page.screenshot(path="/home/igor/study/diploma/docs/screenshots/e2e_03_task.png", full_page=True)
        ...
        page.screenshot(path="/home/igor/study/diploma/docs/screenshots/e2e_04_answered.png", full_page=True)
        ...
        page.screenshot(path="/home/igor/study/diploma/docs/screenshots/e2e_05_next_task.png", full_page=True)
        ...
        page.screenshot(path="/home/igor/study/diploma/docs/screenshots/e2e_06_progress.png", full_page=True)
        ...
        page.screenshot(path="/home/igor/study/diploma/docs/screenshots/e2e_07_too_hard.png", full_page=True)
